        ...
        <div class="margin">
            <table class="vertical-table table table-striped table_view">
                ...
                <tr>
                    ...
                    <td><?= $storesVideo->has('stores_course') ? $this->Html->link(h($storesVideo->stores_course->course), ['controller' => 'StoresCourses', 'action' => 'view', $storesVideo->stores_course->id]) : '' ?></td>
                </tr>
                <tr>
