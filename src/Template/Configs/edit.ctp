...
<div class="col-md-6 form-add-window">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title"><?= __('Editar Configurações') ?></h3>
        </div>
        ...
        <div class="card-body">
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    ...
                    <?php endif; ?>
                    <label for="status_banner_promocional" class="custom-control-label"><?= __('Banner Promocional') ?></label>
                </div>
            </div>
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    ...
                    <?php endif; ?>
                    <label for="customCheckbox1" class="custom-control-label"><?= __('Produtos Físicos') ?></label>
                </div>
                <div class="custom-control custom-checkbox">
                    ...
                    <?php endif; ?>
                    <label for="customCheckbox2" class="custom-control-label"><?= __('Produtos Digitais') ?></label>
                </div>
            </div>
