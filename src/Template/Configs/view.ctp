    ...
    <div class="card-body">
        <div class="margin">
            <div class="form-group">
                <div class="btn-group">
                    <?= $this->Html->link(__('Editar Todas as Configurações'), ['action' => 'edit', $config->id], ['class' => 'btn btn-warning']) ?>
                </div>
            </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        switch ($config->show_type_products) {
                            case 1:
                                echo __('Exibindo apenas produtos físicos');
                                break;
                            case 2:
                                echo __('Exibindo apenas produtos digitais.');
                                break;
                            case 3:
                                echo __('Exibindo produtos físicos e digitais.');
                                break;
                        }
                        ?>
                    </td>
