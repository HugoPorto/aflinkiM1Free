<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3 bg-success"
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?= __("Atualizar Nº do Whatsapp") ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3 bg-primary"
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?= __("Atualizar Link do Facebook") ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3"
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?= __("Atualizar Link do Instagram") ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3 bg-danger"
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?= __("Banner Promocional") ?></span>
            </div>
        </div>
    </div>
</div>