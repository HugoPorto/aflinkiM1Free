...
<script src="<?php // echo $this->request->webroot . 'adminlte/plugins/chart.js/Chart.min.js';
                ?>"></script>
<script src="<?php // echo $this->request->webroot . 'adminlte/dist/js/pages/dashboard3.js';
                ?>"></script>
