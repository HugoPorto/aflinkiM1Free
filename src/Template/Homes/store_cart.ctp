            ...
            <div class="row order-container">
                <div class="col-lg-6">
                    <h3 class="bg-sand">Selecionar Endereço e Calcular Frete</h3>
                        ...
                        <form method="post" class="order-single" accept-charset="utf-8" action="<?= $this->request->base ?>/stores-address/addSession">
                            ...
                            <button type="submit" class="btn btn-info btn-default card-btn" style="margin: 20px;">Selecionar Endereço</button>
                        </form>

                </div>

                <?= $this->element('store_cart_cart') ?>
