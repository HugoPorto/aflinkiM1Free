    ...
    <main role="main">
                    ...
                    <?php foreach ($tablescolibris as $tablescolibri) : ?>
                        <div class="col-md-3">
                            <div class="card mb-4 shadow-sm" style="border: 1px solid #fc7700;">
                                <div class="card-body">
                                    <h4 class="card-text"><?= h($tablescolibri->title); ?></h4>
                                    <p class="card-text"><?= h($tablescolibri->text); ?></p>
        ...
        <?php
            echo $this->Html->script(
                '/bootstrap/js/docs/vendor/jquery-3.3.1.slim.min.js',
                [
            ...
            echo $this->Html->script(
                '/bootstrap/js/docs/vendor/bootstrap.bundle.js',
                [
